...
from testExtraction import extract_name
from testExtraction import extract_cumulative_time
...
moveCoords , names, times = parse_file(r"C:\Users\rayya\Desktop\Ship-Sorting-Balancing-CodeCraft-Solutions-Backend-\Transfer.txt")
